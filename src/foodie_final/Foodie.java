...
public class Foodie {
	...
	public static void main(String[] args) throws IOException {
		// set up data
		Scanner scanner1 = new Scanner(Paths.get("src/Foodie/allrestaurants.txt"), StandardCharsets.UTF_8.name());
		...
		Scanner scanner2 = new Scanner(Paths.get("src/Foodie/allusers.txt"), StandardCharsets.UTF_8.name());
		...
		data.updateUsers(new File("src/Foodie/allrestaurants.txt"));
	}
}