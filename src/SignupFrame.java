...
public class SignupFrame extends JFrame {
	...
	private Image img_logo = new ImageIcon(
			SignupFrame.class.getResource("/com/foodie/resources/SpartanSpirit[2color]_uncoated.png")).getImage()
		...
		txtSignUp_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (e.getSource() == done) {
					...
					User newUser = new Spartan(username.getText(), new String(password.getPassword()),
							new Preferences[] {});
					users.add(newUser);
